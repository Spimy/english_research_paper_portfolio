...
export const writtenResponses: Tab[] = [
	{
		...
		references: [
			...
			{
				author: 'Livazović, G., & Bojčić, K. (2019).  BMC Psychiatry, 19',
				title:
	...
	},
	{
		...
		references: [
			...
			{
				author: 'Khan, S., & Ali, K. S. (2022).',
				title: 'Online Gambling and Money Laundering: Combatting the challenges.',
